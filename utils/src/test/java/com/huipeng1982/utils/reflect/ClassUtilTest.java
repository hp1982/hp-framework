...
public class ClassUtilTest {
    ...
    public void getMessage() {
        ...
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class)).isEqualTo("com.huipeng1982.utils.reflect");
        assertThat(ClassUtil.getPackageName(BClass.class)).isEqualTo("com.huipeng1982.utils.reflect");
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class.getName())).isEqualTo("com.huipeng1982.utils.reflect");
        assertThat(ClassUtil.getPackageName(BClass.class.getName())).isEqualTo("com.huipeng1982.utils.reflect");
    ...
    public void classPresent() {
        ...
        assertThat(ClassLoaderUtil.isPresent("com.huipeng1982.utils.reflect.ClassUtilTest",
            ClassLoaderUtil.getDefaultClassLoader())).isTrue();
    }

    /**
     * Unit test case of {@link com.huipeng1982.utils.reflect.ClassUtil#isSubClassOrInterfaceOf(Class, Class)}
     */
    @Test
