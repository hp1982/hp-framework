...
import com.huipeng1982.utils.base.SystemPropertiesUtil.AbstractPropertiesListener;
import com.huipeng1982.utils.number.RandomUtil;
...
public class SystemPropertiesUtilTest {
    ...
    public void listenableProperties() {
        ...
        TestAbstractPropertiesListener listener = new TestAbstractPropertiesListener(name);
    ...
    public static class TestAbstractPropertiesListener extends AbstractPropertiesListener {

        public String newValue;

        public TestAbstractPropertiesListener(String propertyName) {
            super(propertyName);
        }
