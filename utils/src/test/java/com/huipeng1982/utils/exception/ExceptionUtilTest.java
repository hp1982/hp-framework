package com.huipeng1982.utils.exception;

import com.huipeng1982.utils.exception.type.CloneableException;
import com.huipeng1982.utils.exception.type.CloneableRuntimeException;
import com.huipeng1982.utils.exception.type.UncheckedException;
...
public class ExceptionUtilTest {
    ...
    public void staticException() {
        assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION)).hasLineCount(2)
            ...
            .contains("at com.huipeng1982.utils.exception.ExceptionUtilTest.hello(Unknown Source)");

        assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION2)).hasLineCount(2)
            .contains("com.huipeng1982.utils.exception.type.CloneableException: Timeout")
            .contains("at com.huipeng1982.utils.exception.ExceptionUtilTest.hello(Unknown Source)");
        ...
        assertThat(ExceptionUtil.stackTraceText(timeoutException)).hasLineCount(2)
            .contains("com.huipeng1982.utils.exception.type.CloneableException: Timeout for 30ms")
            .contains("at com.huipeng1982.utils.exception.ExceptionUtilTest.hello(Unknown Source)");

        assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION3)).hasLineCount(2)
            .contains("com.huipeng1982.utils.exception.type.CloneableRuntimeException: Timeout")
            .contains("at com.huipeng1982.utils.exception.ExceptionUtilTest.hello(Unknown Source)");
        ...
        assertThat(ExceptionUtil.stackTraceText(timeoutRuntimeException)).hasLineCount(2)
            .contains("com.huipeng1982.utils.exception.type.CloneableRuntimeException: Timeout for 40ms")
            .contains("at com.huipeng1982.utils.exception.ExceptionUtilTest.hello(Unknown Source)");
