...
public class DateUtil {
    ...
    public static boolean isLeapYear(int y) {
        ...
        // must be divisible by 4... and either before reform year... or not a century... or a multiple of 400...
        boolean condition = ((y % LEAP_YEAR_4) == 0) && ((y < 1582) || ((y % 100) != 0) || ((y % 400) == 0));
        if (condition) {
            result = true;
        }
        return result;
