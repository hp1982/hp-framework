...
import com.huipeng1982.utils.base.annotation.NotNull;
...
public class FileUtil {
    ...
    private static final String IS_NOT_A_FILE = "%s is not exist or not a file";
    private static final String IS_NOT_A_DIR = "%s is not exist or not a dir";
    /**
    ...
    public static InputStream asInputStream(Path path) throws IOException {
        Validate.notNull(path, PATH_IS_NULL);
    ...
    public static void copyFile(@NotNull Path from, @NotNull Path to) throws IOException {
        Validate.isTrue(from.toFile().exists(), IS_NOT_A_FILE, from);
        Validate.notNull(to);
    ...
    public static void copyDir(@NotNull File from, @NotNull File to) throws IOException {
        Validate.isTrue(isDirExists(from), IS_NOT_A_DIR, from);
        Validate.notNull(to);
    ...
    public static void moveFile(@NotNull Path from, @NotNull Path to) throws IOException {
        Validate.isTrue(isFileExists(from), IS_NOT_A_FILE, from);
        Validate.notNull(to);
    ...
    public static void deleteFile(@Nullable File file) throws IOException {
        Validate.isTrue(isFileExists(file), IS_NOT_A_FILE, file);
    ...
    public static void deleteFile(@Nullable Path path) throws IOException {
        Validate.isTrue(isFileExists(path), IS_NOT_A_FILE, path);
    ...
    public static void deleteDir(Path dir) throws IOException {
        Validate.isTrue(isDirExists(dir), IS_NOT_A_DIR, dir);
