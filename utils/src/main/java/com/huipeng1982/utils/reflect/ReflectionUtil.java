...
import com.huipeng1982.utils.base.ObjectUtil;
...
public class ReflectionUtil {
    ...
    public static <T> T invokeGetter(Object obj, String propertyName) {
        ...
        if (method == null) {
            throw new IllegalArgumentException(
                "Could not find getter method [" + propertyName + ON_TARGET + obj + ']');
        }
    ...
    public static void makeAccessible(Method method) {
        boolean notAccessible = !method.isAccessible() && (!Modifier.isPublic(method.getModifiers())
    ...
    public static void makeAccessible(Field field) {
        boolean notAccessible = !field.isAccessible() && (!Modifier.isPublic(field.getModifiers())
