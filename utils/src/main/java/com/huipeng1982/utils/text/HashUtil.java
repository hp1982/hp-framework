        ...
        return new ThreadLocal<MessageDigest>() {
            ...
            protected MessageDigest initialValue() {
                try {
                    ...
                    throw new MessageDigestCreatingException(digest, e);
                }
            }
        };
    }
