...
public class SystemPropertiesUtil {
    ...
    private static final char NOT_SUPPORT_IN_LINUX_ENV = '.';
    ...
    private static void checkEnvName(String envName) {
        if (envName == null || envName.indexOf(NOT_SUPPORT_IN_LINUX_ENV) != -1) {
     ...
     */
    public static synchronized void registerSystemPropertiesListener(AbstractPropertiesListener listener) {
     ...
     * 在其所关心的属性变化时进行通知.
     *
     * @see AbstractPropertiesListener
     */
    public static class ListenableProperties extends Properties {
        ...
        public void register(AbstractPropertiesListener listener) {
    ...
    public abstract static class AbstractPropertiesListener {
        ...
        public AbstractPropertiesListener(String propertyName) {
