...
import com.huipeng1982.utils.mapper.type.JaxbContextInstantiateException;
import com.huipeng1982.utils.reflect.ClassUtil;
    ...
    protected static JAXBContext getJaxbContext(Class clazz) {
        ...
        if (jaxbContext == null) {
            try {
                ...
                throw new JaxbContextInstantiateException(
