package com.huipeng1982.spring.redis.starter.config;
...
public class RedisConfig {
    ...
    @Bean
    public ReactiveRedisTemplate<String, Employee> reactiveRedisEmployeeTemplate(ReactiveRedisConnectionFactory factory) {
